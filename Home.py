...
# Getting the channel ids from the user
channel_id = st.text_input("Enter the channel_id").split(",")

# buttions to submit the data and to ckear the database 
...
if button1 :
    ...
    # storing the values into session state keys     
